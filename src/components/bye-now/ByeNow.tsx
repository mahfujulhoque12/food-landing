  ...
  return (
    ...
    <MaxWidthWrapper>
      <div className="my-10 max-w-2xl mx-auto  bg-[var(--badge-bg)] p-6 rounded-lg shadow-md border border-gray-300">
        <h2 className="text-2xl font-bold mb-4 text-center text-[#D84040]">Buy Your Food</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="relative cursor-pointer overflow-hidden text-xl font-bold text-white bg-[var(--btn-bg)]  px-6 py-3 rounded-md w-full block text-center group"
          >
            <span className="relative z-10"> {isLoading ? 'Placing Order...' : 'Place Order'}</span>
